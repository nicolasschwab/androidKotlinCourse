...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Timber.i( "on create method called")
    ...
    override fun onSaveInstanceState(outState: Bundle?) {
        ...
        Timber.i("on save instances called")
    ...
    override fun onPause() {
        super.onPause()
        Timber.i("on pause method called")
    }

    override fun onResume() {
        super.onResume()
        Timber.i("on resume method called")
    }

    override fun onDestroy() {
        super.onDestroy()
        Timber.i("on destroy method called")
    }

    override fun onRestart() {
        super.onRestart()
        Timber.i("on restart method called")
    }

    override fun onStop() {
        super.onStop()
        Timber.i("on stop method called")
    }
}
